...
// need to fix the add user graphql...
        // const mutationResponse = await addUser({
        //     variables: {
        //         firstName: formState.firstName, lastName: formState.lastName, email: formState.email, password: formState.password
        //     }
        // });
                        ...
                        <Col className="ml-auto mr-auto" md={5}>
                            <Form>
                                ...
                                <Form.Group controlId="lastName">
                                    ...
                                    <Form.Control placeholder="Last name" name="lastName" onChange={handleChange} />
                                </Form.Group>
